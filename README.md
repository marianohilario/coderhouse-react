...
<br />
<h3 align="center">Video de navegación en la aplicación <a href="https://www.youtube.com/watch?v=KAZDMQTyHzU">(click para ver)</a>
</h3>
...
Para crear la funcionalidad necesaria para un proyecto ecommerce con carrito tuve que crear varios componentes. NavBar, Footer, CartContext, CartWidget, Item, ItemList, ItemListContainer, ItemDetailContainer, ItemDetail, ItemCount, LoadingSpinner y CartView, CheckOut.
